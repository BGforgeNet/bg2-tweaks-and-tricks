 ...
 */
const daggersRare = ["dagg16"];
/** Rare magic ammo */
export const ammoMagicRare = [
    ...arrowsMagicRare,
    ...boltsMagicRare,
    ...bulletsMagicRare,
    ...dartsMagicRare,
...
export function pickupJewelsMagic() {
    if (tCanPickup() && GGT(GVAR_pickupJewels, 0)) {
        sprint();
